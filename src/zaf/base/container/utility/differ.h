...
Out<typename In1::value_type> Differ(const In1& container1, const In2& container2) {
...
Out<typename In1::value_type> Differ(const In1& container1, const In2& container2, Predicate predicate) {
    Out<typename In1::value_type> result;
    std::set_difference(
        container1.begin(), container1.end(),
        container2.begin(), container2.end(),
