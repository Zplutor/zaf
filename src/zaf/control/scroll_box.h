...
ZAF_OBJECT_PROPERTY(AllowVerticalScroll)
ZAF_OBJECT_PROPERTY(AllowHorizontalScroll)
ZAF_OBJECT_PROPERTY(AutoScrollBarLargeChange)
ZAF_OBJECT_PROPERTY(AutoScrollContentHeight)
ZAF_OBJECT_PROPERTY(AutoScrollContentSize)
ZAF_OBJECT_PROPERTY(AutoScrollContentWidth)
ZAF_OBJECT_PROPERTY(AutoHideScrollBars)
ZAF_OBJECT_PROPERTY(ScrollBarThickness)
ZAF_OBJECT_PROPERTY(UseOverlayScrollBars)
ZAF_OBJECT_PROPERTY(HorizontalScrollBar)
ZAF_OBJECT_PROPERTY(HorizontalScrollBarThickness)
