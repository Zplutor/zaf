...
ZAF_OBJECT_PROPERTY(AcceptReturn)
ZAF_OBJECT_PROPERTY(AcceptTab)
ZAF_OBJECT_PROPERTY(AllowBeep)
ZAF_OBJECT_PROPERTY(IsReadOnly)
ZAF_OBJECT_PROPERTY(IsMultiline)
ZAF_OBJECT_PROPERTY(UsePasswordCharacter)
