...
bool RangeManager::AddRange(const Range& new_range, std::any data) {
    return ReplaceRange(new_range, std::move(data));
}


bool RangeManager::AddRange(const Range& new_range) {
    return AddRange(new_range, {});
}
...
bool RangeManager::ReplaceRange(const Range& replaced_range, std::optional<std::any> data) {
...
const Range& RangeManager::GetRange(std::size_t range_index) const {
    ZAF_EXPECT(range_index < items_.size());
    return items_[range_index].range;
}


const std::any& RangeManager::GetRangeData(std::size_t range_index) const {
    ZAF_EXPECT(range_index < items_.size());
    return items_[range_index].data;
}


const std::any* RangeManager::GetRangeDataAtIndex(std::size_t index) const {
...
bool RangeManager::IsIndexInRange(std::size_t index) const {
    return !!GetItemAtIndex(index);
}


const RangeManager::Item* RangeManager::GetItemAtIndex(std::size_t index) const {
