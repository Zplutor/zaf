...
TEST(CheckBox, Deserialize) {
    ...
    auto check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>(json);
...
TEST(CheckBox, DeserializeBoxBackgroundColor) {
    ...
    auto check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"BoxBackgroundColor\": {\"R\": 0.98,\"G\": 0.89}}");
...
TEST(CheckBox, DeserializeBoxBorderColor) {
    ...
    auto check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"BoxBorderColor\": { \"G\": 0.46, \"B\": 0.64 }}");
...
TEST(CheckBox, DeserializeCheckState) {
    ...
    auto check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"CheckState\": \"Checked\"}");
    ASSERT_EQ(check_box->GetCheckState(), zaf::CheckState::Checked);

    check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"CheckState\": \"Indeterminate\"}");
    ASSERT_EQ(check_box->GetCheckState(), zaf::CheckState::Indeterminate);

    check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"CheckState\": \"Unchecked\"}");
    ASSERT_EQ(check_box->GetCheckState(), zaf::CheckState::Unchecked);

    check_box = zaf::DeserializeObjectFromJson<zaf::CheckBox>("{\"CheckState\": \"dafo23o\"}");
    ASSERT_EQ(check_box->GetCheckState(), zaf::CheckState::Unchecked);
}