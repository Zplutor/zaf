...
TEST(StyledTextTest, Slice) {
...

    {
        ...
        ASSERT_EQ(slice.DefaultStyle().TextColorPicker(), StaticColorPicker{ Color::Red() });
        ASSERT_EQ(slice.DefaultStyle().TextBackColorPicker(), StaticColorPicker{ Color::Green() });
        ...
        ASSERT_EQ(text_color_item.ColorPicker(), StaticColorPicker{ Color::Yellow() });
        ...
        ASSERT_EQ(text_back_color_item.ColorPicker(), StaticColorPicker{ Color::Gray() });
