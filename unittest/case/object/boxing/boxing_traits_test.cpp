...
static_assert(std::is_same_v<BoxingTraits<Point>::InstanceType, std::shared_ptr<Point>>);
...
static_assert(std::is_same_v<BoxingTraits<const Point>::InstanceType, std::shared_ptr<Point>>);
...
static_assert(std::is_same_v<BoxingTraits<bool>::InstanceType, std::shared_ptr<Boolean>>);
...
static_assert(std::is_same_v<BoxingTraits<const bool>::InstanceType, std::shared_ptr<Boolean>>);
